  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm transition-all">
      <div className="w-full max-w-lg glass-panel rounded-3xl overflow-hidden border border-indigo-500/20 relative shadow-2xl">
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-indigo-500/10 bg-slate-900/20 p-2 gap-1 font-mono text-xs">
        ...
        <div className="p-6 space-y-6">
          ...
          {category === 'transport' && (
            <div className="space-y-4">
              <div>
                <label className="block text-slate-400 font-mono text-[10px] uppercase mb-2">Transport Mode</label>
              ...
              <div>
                <label className="flex justify-between text-slate-300 font-mono text-[10px] uppercase mb-2">
          ...
          {category === 'energy' && (
            <div className="space-y-4">
              <div>
                <label className="block text-slate-400 font-mono text-[10px] uppercase mb-2">Power Feed Source</label>
          ...
          {category === 'food' && (
            <div className="space-y-4">
              <div>
                <label className="block text-slate-400 font-mono text-[10px] uppercase mb-2">Diet Profile</label>
          ...
          {category === 'waste' && (
            <div className="space-y-4">
              <div>
                <label className="block text-slate-400 font-mono text-[10px] uppercase mb-2">Disposal Type</label>
                <div className="grid grid-cols-2 gap-2">
